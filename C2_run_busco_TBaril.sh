...
#SBATCH --array=1-21%10 # submit 42 tasks with task ID 1,2,...,21.
...
param_store=/data/alicel/chapter2/1_dataTreatment/2_phyloTree/1_busco/buscoParameters.21.txt
##### param_store contains tab-separated lines that look like #####
##### agabis3.fna	BUSCO_agabis3 #####
### this file contains 42 lines with 2 arguments per line
